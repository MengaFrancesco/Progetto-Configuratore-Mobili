...
<head>
  <title>Homepage - JM Arredamenti</title>
  <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-lg-4">
              <nav class="site-navigation text-right ml-auto " role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                  <li class="active"><a href="index.php" class="nav-link">Homepage</a></li>
                  <li><a href="ChiSiamo.php" class="nav-link">Chi siamo</a></li>
            ...
            <div class="col-lg-4 text-center">
              <div>
                <h2><a href="index.html" style="font-family: sans-serif;">JM Arredamenti</a></h2>
              </div>
            ...
            <div class="col-lg-4">
              <nav class="site-navigation text-left mr-auto " role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                  ...
                  <li><a href="Configuratori.php" class="nav-link">Configuratori</a></li>
                  <li><a href="Galleria.php" class="nav-link">Galleria</a></li>
                </ul>
              </nav>
            </div>
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819 shadow-lg">
          ...
          <div>
            <h1 class=" mb-3 text-black">Configuratore di Ambienti</h1>
            <p>Accedi ad una vasta gamma di mobili e inizia adesso a configurare l'arredamento</p>
            <p class="mb-0 mt-4"><a href="configuratori.php" class="btn btn-primary">Inizia ora</a></p>
          </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row mb-5 align-items-center">
          <div class="col-md-7">
            <h2 class="heading-39291 mb-0">Ambienti creati da noi</h2>
          </div>
          <div class="col-md-5 text-right">
            <p class="mb-0"><a href="#" class="more-39291">Vedi tutti gli esempi</a></p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="media-02819">
              ...
              <h3><a href="#">Cucina e Giardino</a></h3>
          ...
          <div class="col-lg-6">
            <div class="media-02819">
              <a href="#" class="img-link"><img src="https://i.pinimg.com/originals/eb/25/06/eb2506d2dd6ede4b6fc98d68f06669cc.png" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-lg-6">
            <div class="media-02819">
              <a href="#" class="img-link"><img src="https://www.italianbark.com/wp-content/uploads/2017/12/7-citylife-milano-shopping-center-.jpg" alt="Image" class="img-fluid"></a>
              <h3><a href="#">Modern Living Room</a></h3>
    ...
    <div class="site-section bg-primary">
      <div class="container">
        <div class="row mb-5 align-items-center">
          <div class="col-md-7">
            <h2 class="heading-39291 text-white mb-3">I nostri servizi</h2>
            <p class="text-white">Da anni forniamo ai nostri clienti i servizi tra i migliori nel settore</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6 mb-4 col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="service-29193 text-center">
              ...
              <h3 class="mb-4"><a href="#">Configuratore Ambienti</a></h3>
          ...
          <div class="col-md-6 mb-4 col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="service-29193 text-center">
              ...
              <h3 class="mb-4"><a href="#">Vendita al Dettaglio</a></h3>
              <p>Lorem ipsum dolor sit ame adipisicing elit. Perspiciatis incidunt distinctio voluptate .</p>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-4 col-lg-4" data-aos="fade-up" data-aos-delay="">
            <div class="service-29193 text-center">
              ...
              <h3 class="mb-4"><a href="#">Configurazione in negozio</a></h3>
              <p>Lorem ipsum dolor sit ame adipisicing elit. Perspiciatis incidunt distinctio voluptate .</p>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-4 col-lg-4" data-aos="fade-up" data-aos-delay="">
            <div class="service-29193 text-center">
              ...
              <h3 class="mb-4"><a href="#">Assistenza clienti</a></h3>
              <p>Lorem ipsum dolor sit ame adipisicing elit. Perspiciatis incidunt distinctio voluptate .</p>
            </div>
          </div>
          <div class="col-md-6 mb-4 col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="service-29193 text-center">
              ...
              <h3 class="mb-4"><a href="#">Assistenza consegne</a></h3>
              <p>Lorem ipsum dolor sit ame adipisicing elit. Perspiciatis incidunt distinctio voluptate .</p>
            </div>
          </div>
          <div class="col-md-6 mb-4 col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="service-29193 text-center">
              ...
              <h3 class="mb-4"><a href="#">Montaggio Mobili</a></h3>
              <p>Lorem ipsum dolor sit ame adipisicing elit. Perspiciatis incidunt distinctio voluptate .</p>
            </div>
          </div>
